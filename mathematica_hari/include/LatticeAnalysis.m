...
Mom0Ratio::usage="Mom0Ratio[threeptmdb,nucmassdb,Options...] will form ratios of 3- and 2-point functions. \
	You have to supply a MemDB data base structure with 3-point functions in threeptmdb and \
	a MemDB data base structure with 2-point functions in nucmassdb.";
...
Mom0Ratio[threeptmdb_,twoptmdb_,opts:OptionsPattern[]] := 
	Module[{mom,tsep,ind,denom,resdb},
